...
// Access Control: Only logged-in users can manage products
...
// --- 3. READ OPERATION (Fetch all products) ---
...
<head>
    ...
    <style>
        ...
        .btn { background: #00ff87; color: #121214; border: none; padding: 10px 15px; cursor: pointer; font-weight: bold; }
...
<body>
    ...
    <p><a href="logout.php" style="color: #00ff87;">Logout</a></p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn-delete" href="products.php?delete_id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
